...
void StageSelectScene::Initialize() {
    ...
    // scoreboard
    btn = new Engine::ImageButton("stage-select/dirt.png", "stage-select/floor.png", 60, halfH / 2 + 520, 400, 50);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::ScoreboardOnClick, this));
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Scoreboard", "pirulen.ttf", 36, 260, halfH / 2 + 545, 0, 0, 0, 255, 0.5, 0.5));
